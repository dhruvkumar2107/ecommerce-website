    ...
    return (
        <nav className={`fixed top-0 w-full z-50 transition-all duration-700 ease-in-out ${navClass}`}>
            ...
            <div className="container mx-auto px-6 flex justify-between items-center relative z-10">
                {/* Logo - Vivid Orange & Transparent via Lighten Blend */}
                <Link to="/" className="block w-24 md:w-36">
                    <img
                        src="/images/ayodhya_logo.png"
                        alt="Ayodhya Agarbatti"
                        className="w-full h-auto filter invert hue-rotate-180 brightness-200 saturate-200 contrast-125 mix-blend-lighten block"
                    />
                </Link>
                {/* Desktop Menu */}
